...
여행지와 여행 시기, 사진 1–5장으로 다섯 가지 Cookie:Ro Flavor 중 하나를 발견하고, 친구와 결과를 비교하는 모바일 중심 정적 웹사이트입니다.
...
- 색상 비율은 쿠키의 고정 팔레트가 아니라 업로드한 1~5장 사진의 실제 픽셀에서 일곱 개 대표색을 추출하며, 표시 비율의 합은 100%입니다.
...
- 공유 링크로 들어온 친구도 여행지·시기·사진 1~5장을 입력하며, Flavor Match 아래에서 여행 코멘트·현지 계절·음식·실제 사진 색상 비율과 jar까지 동일하게 확인합니다.
